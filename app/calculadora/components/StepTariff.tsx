  ...
  return (
    <WizardStepLayout
      banner={
        <WizardStepBanner
          stepIndex={stepIndex}
          title="Tipo de tarifa eléctrica"
          subtitle="Seleccioná el tipo de tarifa que tenés contratada."
        />
      }
    >
      ...
      <p className="mb-4 text-sm leading-relaxed text-slate-600">
        Si no estás seguro, seleccioná la opción correspondiente o usá el promedio industrial
        estimado.
      </p>
      <select
        value={selection}
      ...
      {showUnknownInfo && (
        <p className="mt-2 max-w-md text-sm leading-relaxed text-slate-600">
          Utilizaremos una tarifa estimada para los cálculos iniciales. Podrás ajustarla más
          adelante con un asesor.
        </p>
      )}
